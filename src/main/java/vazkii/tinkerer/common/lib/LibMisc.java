...
public final class LibMisc {
	...
	public static final String VERSION = "2.2b FC-86";

	public static final String NETWORK_CHANNEL = MOD_ID;

	public static final String DEPENDENCIES = "required-after:Thaumcraft;before:MagicBees;after:IC2;after:ThaumicTinkererKami;after:Waila";
